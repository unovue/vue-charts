import type { TextAnchor, TextVerticalAnchor } from './getCartesianPosition'
 ...
 *
 * horizontalPosition is type: 'start' | 'middle' | 'end' | 'inherit'
 * verticalPosition is type: 'start' | 'middle' | 'end'
 *
